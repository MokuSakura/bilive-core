...
import org.mokusakura.bilive.core.model.CommentModel;
...
public class TestXmlWriter {
    ...
    public void testEnable() {
        ...
        for (int i = 0; i < 1000; i++) {
            danmakuWriter.write(CommentModel.createFromJson(json));
        }
        danmakuWriter.close();
    }
    ...
    public void testProperties() {
        ...
        properties.load(new FileInputStream("D:\\Code\\Java\\bilive-core\\src\\main\\resources\\xmlWriter.properties"));
