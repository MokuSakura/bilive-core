...
public class CompressedBilibiliMessageFactory implements BilibiliMessageFactory {
    private final DefaultBilibiliMessageFactory defaultBilibiliMessageFactory;

    public CompressedBilibiliMessageFactory(DefaultBilibiliMessageFactory defaultBilibiliMessageFactory) {
    ...
    public List<GenericBilibiliMessage> create(BilibiliWebSocketFrame frame) {
        ...
        try {
            ...
            inflater.setInput(frame.getWebSocketBody());
            int inflateLength;
